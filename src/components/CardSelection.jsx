...
const CardSelection = () => {
  const { setGameConfig, setTeams, gameConfig, addCardsToDeck, teams } = useGameContext();
  ...
  if(isObjectEmpty(gameConfig)) {
      setGameConfig({numPlayers: DEFAULT_SETTINGS.numPlayers, cardsPerPlayer: DEFAULT_SETTINGS.cardsPerPlayer,timeLimit: DEFAULT_SETTINGS.timeLimit });
  ...
  const selectCard = (card) => {
    if (
      ...
      setSelectedCards(selectedCards.filter(selectCard => selectCard !== card))
    }
  };
